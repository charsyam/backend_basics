...
def get_response_by_count(token, count, maximum_count):
    ...
    if count < maximum_count:
        msg = "Hello World!(Left: {count})".format(count=API_DAILY_MAXIMUM_NUMBER-count)
    else:
...
def hello():
    ...
    try:
        ...
        msg, status = get_response_by_count(access_token, count, API_DAILY_MAXIMUM_NUMBER)
